    ...
    try {
      ...
      axios.post('/api/adm/cakes/uploadnewcakeimages', fd, {
        onUploadProgress(progressEvent) {
          ...
          const newCakeImageObject = { ...cakeImageObjectToAdd };
        ...
        const newCakeImageObject = getState().admCakeEditReducer.cakeImages.slice()[counter];
        newCakeImageObject.cakeImageAddress = imgAddress;
        const cakeImagesCopy = getState().admCakeEditReducer.cakeImages.slice();
